...
#define COLOR_DEPTH_TYPE int16_t
#elif (USE_COLOR_DEPTH == 24 || USE_COLOR_DEPTH == 32)
#define COLOR_DEPTH_TYPE int32_t
#endif
 
 
#if (USE_COLOR_DEPTH == 15)
 
#define GETR(c)    (((uint16_t)(c)) >> 10)
...
void resize_bitmap(BITMAP *src, BITMAP *dest)
{
    ...
    for (j=0; j<desth; j++)
    {
        ...
        for(i=0; i<destw; i++)
        {
            ...
            if ((c1_rgb[0] == 255 && c1_rgb[1] == 0 && c1_rgb[2] == 255) ||
               (c2_rgb[0] == 255 && c2_rgb[1] == 0 && c2_rgb[2] == 255) ||
               (c3_rgb[0] == 255 && c2_rgb[1] == 0 && c2_rgb[2] == 255) ||
               (c4_rgb[0] == 255 && c2_rgb[1] == 0 && c2_rgb[2] == 255)) {
                r = 255;
                g = 0;
                b = 255;
            }
